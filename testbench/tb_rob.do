...
add wave -noupdate /tb_rob/ROB/i_flush_req
add wave -noupdate -divider commit
add wave -noupdate /tb_rob/ROB/o_commit_BREADY
add wave -noupdate /tb_rob/ROB/i_commit_BVALID
add wave -noupdate /tb_rob/ROB/i_commit_BDATA
add wave -noupdate /tb_rob/ROB/i_commit_id
add wave -noupdate -divider issue
add wave -noupdate /tb_rob/ROB/o_issue_AREADY
add wave -noupdate /tb_rob/ROB/i_issue_AVALID
add wave -noupdate /tb_rob/ROB/i_issue_rd_addr
add wave -noupdate /tb_rob/ROB/i_issue_rd_we
add wave -noupdate /tb_rob/ROB/i_issue_rs1_addr
add wave -noupdate /tb_rob/ROB/i_issue_rs2_addr
add wave -noupdate /tb_rob/ROB/o_issue_id
add wave -noupdate /tb_rob/ROB/o_issue_rs1_from_ROB
add wave -noupdate /tb_rob/ROB/o_issue_rs1_dat
add wave -noupdate /tb_rob/ROB/o_issue_rs2_from_ROB
add wave -noupdate /tb_rob/ROB/o_issue_rs2_dat
add wave -noupdate /tb_rob/ROB/o_issue_rs1_in_ARF
add wave -noupdate /tb_rob/ROB/o_issue_rs2_in_ARF
add wave -noupdate -divider debug
add wave -noupdate /tb_rob/ROB/rs1_first_ready
add wave -noupdate /tb_rob/ROB/rs2_first_ready
...
add wave -noupdate /tb_rob/ROB/i_retire_BREADY
add wave -noupdate /tb_rob/ROB/o_retire_BVALID
add wave -noupdate /tb_rob/ROB/o_retire_BDATA
add wave -noupdate /tb_rob/ROB/o_retire_BTAG
add wave -noupdate /tb_rob/ROB/o_retire_rd_addr
add wave -noupdate /tb_rob/ROB/o_retire_rd_we
...
add wave -noupdate -radix hexadecimal /tb_rob/ROB/que_dat_r
...
WaveRestoreCursors {{Cursor 1} {622043 ps} 0}
...
update
WaveRestoreZoom {491839 ps} {1003839 ps}
