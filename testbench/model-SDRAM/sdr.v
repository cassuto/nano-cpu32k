...
module sdr
  #(parameter MEMH_FILE_B0="",parameter MEMH_FILE_B1="",parameter MEMH_FILE_B2="",parameter MEMH_FILE_B3="")
...
`include "sdr_parameters.vh"
    ...
    initial begin : initial_block
      integer i;
      for(i=0;i<mem_sizes;i=i+1) begin : for_size_bytes
         Bank0[i] = 0;
         Bank1[i] = 0;
         Bank2[i] = 0;
         Bank3[i] = 0;
      end
      if(MEMH_FILE_B0 !== "") begin :memh_file_not_emp
         $readmemh (MEMH_FILE_B0, Bank0);
         $readmemh (MEMH_FILE_B1, Bank1);
         $readmemh (MEMH_FILE_B2, Bank2);
         $readmemh (MEMH_FILE_B3, Bank3);
      end
   end
    ...
    wire      Debug_AREF       = 1'b0;                          // Debug AREF
